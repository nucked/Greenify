...
.method public static a(Landroid/content/Context;)Z
    ...
    invoke-static {p0, v0}, Lajv;->a(Landroid/content/Context;Ljava/lang/Class;)Z
...
# virtual methods
.method public a(Lajk;Landroid/os/Handler;I)V
    .locals 1

    new-instance v0, Laii;

    invoke-direct {v0, p0, p3, p1}, Laii;-><init>(Lcom/google/android/gms/analytics/CampaignTrackingService;ILajk;)V
...
.method public onStartCommand(Landroid/content/Intent;II)I
    ...
    invoke-virtual {v1}, Lakh;->f()Lajk;

    move-result-object v2

    const/4 v0, 0x0

    invoke-virtual {v1}, Lakh;->e()Lalh;

    move-result-object v3

    invoke-virtual {v3}, Lalh;->a()Z
    ...
    invoke-virtual {v2, v3}, Lajk;->f(Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v0}, Lajk;->e(Ljava/lang/String;)V

    :cond_0
    invoke-virtual {v1}, Lakh;->h()Lbcg;

    move-result-object v0

    new-instance v1, Laig;

    invoke-direct {v1, p0, v2, v3, p3}, Laig;-><init>(Lcom/google/android/gms/analytics/CampaignTrackingService;Lajk;Landroid/os/Handler;I)V
    ...
    invoke-virtual {v2, v4, v5, v0}, Lajk;->a(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)V

    invoke-virtual {v1}, Lakh;->i()Lajx;

    move-result-object v1

    new-instance v4, Laih;

    invoke-direct {v4, p0, v2, v3, p3}, Laih;-><init>(Lcom/google/android/gms/analytics/CampaignTrackingService;Lajk;Landroid/os/Handler;I)V

    invoke-virtual {v1, v0, v4}, Lajx;->a(Ljava/lang/String;Ljava/lang/Runnable;)V
    ...
    invoke-virtual {v2, v5, v6, v7}, Lajk;->c(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)V

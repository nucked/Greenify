...
# instance fields
.field public authExpirationBehavior:Lcom/firebase/client/core/AuthExpirationBehavior;

.field public authenticationServer:Ljava/lang/String;

.field public cacheSize:J

.field public credentialStore:Lcom/firebase/client/CredentialStore;

.field public eventTarget:Lcom/firebase/client/EventTarget;

.field private forcedPersistenceManager:Lcom/firebase/client/core/persistence/PersistenceManager;

.field private frozen:Z

.field public logLevel:Lcom/firebase/client/Logger$Level;
...
.field public logger:Lcom/firebase/client/Logger;

.field public persistenceEnabled:Z

.field public persistenceKey:Ljava/lang/String;

.field public runLoop:Lcom/firebase/client/RunLoop;
...
.method public static declared-synchronized setAndroidContext(Landroid/content/Context;)V
    ...
    .prologue
    .line 58
    const-class v1, Lcom/firebase/client/core/Context;

    monitor-enter v1

    :try_start_0
    sget-object v0, Lcom/firebase/client/core/Context;->androidContext:Landroid/content/Context;
    ...
    sput-object v0, Lcom/firebase/client/core/Context;->androidContext:Landroid/content/Context;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    .line 61
    :try_start_1
    const-string v0, "com.firebase.client.android.AndroidPlatform"
    ...
    check-cast v0, Lcom/firebase/client/core/Platform;
    ...
    const-string v2, "Android classes not found. Are you using the firebase-client-android artifact?"
    ...
    const-string v3, "Failed to instantiate AndroidPlatform class.  Using ProGuard?  See http://stackoverflow.com/questions/26273929/what-proguard-configuration-do-i-need-for-firebase-on-android"
    ...
    const-string v3, "Failed to instantiate AndroidPlatform class."

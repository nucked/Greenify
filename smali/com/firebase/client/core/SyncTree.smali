...
.method private applyOperationHelper(Lcom/firebase/client/core/operation/Operation;Lcom/firebase/client/core/utilities/ImmutableTree;Lcom/firebase/client/snapshot/Node;Lcom/firebase/client/core/WriteTreeRef;)Ljava/util/List;
    ...
    .line 785
    invoke-virtual {p1, v4}, Lcom/firebase/client/core/operation/Operation;->operationForChild(Lcom/firebase/client/snapshot/ChildKey;)Lcom/firebase/client/core/operation/Operation;
    ...
    invoke-virtual {v1, v4}, Lcom/firebase/client/collection/ImmutableSortedMap;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-interface {p3, v4}, Lcom/firebase/client/snapshot/Node;->getImmediateChild(Lcom/firebase/client/snapshot/ChildKey;)Lcom/firebase/client/snapshot/Node;

    move-result-object v2

    .line 789
    :goto_1
    invoke-virtual {p4, v4}, Lcom/firebase/client/core/WriteTreeRef;->child(Lcom/firebase/client/snapshot/ChildKey;)Lcom/firebase/client/core/WriteTreeRef;

    move-result-object v4

    .line 790
    invoke-direct {p0, v5, v1, v2, v4}, Lcom/firebase/client/core/SyncTree;->applyOperationHelper(Lcom/firebase/client/core/operation/Operation;Lcom/firebase/client/core/utilities/ImmutableTree;Lcom/firebase/client/snapshot/Node;Lcom/firebase/client/core/WriteTreeRef;)Ljava/util/List;
...
.method private applyTaggedOperation(Lcom/firebase/client/core/view/QuerySpec;Lcom/firebase/client/core/operation/Operation;)Ljava/util/List;
    ...
    .line 339
    sget-boolean v2, Lcom/firebase/client/core/SyncTree;->$assertionsDisabled:Z
    ...
    invoke-virtual {v2, v1}, Lcom/firebase/client/core/WriteTree;->childWrites(Lcom/firebase/client/core/Path;)Lcom/firebase/client/core/WriteTreeRef;
    ...
    invoke-virtual {v0, p2, v1, v2}, Lcom/firebase/client/core/SyncPoint;->applyOperation(Lcom/firebase/client/core/operation/Operation;Lcom/firebase/client/core/WriteTreeRef;Lcom/firebase/client/snapshot/Node;)Ljava/util/List;
...
.method private setupListener(Lcom/firebase/client/core/view/QuerySpec;Lcom/firebase/client/core/view/View;)V
    ...
    .line 670
    iget-object v3, p0, Lcom/firebase/client/core/SyncTree;->listenProvider:Lcom/firebase/client/core/SyncTree$ListenProvider;

    invoke-direct {p0, p1}, Lcom/firebase/client/core/SyncTree;->queryForListening(Lcom/firebase/client/core/view/QuerySpec;)Lcom/firebase/client/core/view/QuerySpec;

    move-result-object v4

    invoke-interface {v3, v4, v1, v2, v2}, Lcom/firebase/client/core/SyncTree$ListenProvider;->startListening(Lcom/firebase/client/core/view/QuerySpec;Lcom/firebase/client/core/Tag;Lcom/firebase/client/core/SyncTree$SyncTreeHash;Lcom/firebase/client/core/SyncTree$CompletionListener;)V

    .line 672
    iget-object v2, p0, Lcom/firebase/client/core/SyncTree;->syncPointTree:Lcom/firebase/client/core/utilities/ImmutableTree;

    invoke-virtual {v2, v0}, Lcom/firebase/client/core/utilities/ImmutableTree;->subtree(Lcom/firebase/client/core/Path;)Lcom/firebase/client/core/utilities/ImmutableTree;
    ...
    .line 676
    sget-boolean v1, Lcom/firebase/client/core/SyncTree;->$assertionsDisabled:Z
    ...
    .line 679
    :cond_0
    new-instance v1, Lcom/firebase/client/core/SyncTree$13;

    invoke-direct {v1, p0}, Lcom/firebase/client/core/SyncTree$13;-><init>(Lcom/firebase/client/core/SyncTree;)V
...
.method public applyServerRangeMerges(Lcom/firebase/client/core/Path;Ljava/util/List;)Ljava/util/List;
    ...
    check-cast v0, Lcom/firebase/client/core/RangeMerge;

    .line 274
    invoke-virtual {v0, v1}, Lcom/firebase/client/core/RangeMerge;->applyTo(Lcom/firebase/client/snapshot/Node;)Lcom/firebase/client/snapshot/Node;
    ...
    .line 276
    :cond_1
    invoke-virtual {p0, p1, v1}, Lcom/firebase/client/core/SyncTree;->applyServerOverwrite(Lcom/firebase/client/core/Path;Lcom/firebase/client/snapshot/Node;)Ljava/util/List;
...
.method public applyTaggedRangeMerges(Lcom/firebase/client/core/Path;Ljava/util/List;Lcom/firebase/client/core/Tag;)Ljava/util/List;
    ...
    .line 288
    sget-boolean v0, Lcom/firebase/client/core/SyncTree;->$assertionsDisabled:Z
    ...
    invoke-virtual {p1, v0}, Lcom/firebase/client/core/Path;->equals(Ljava/lang/Object;)Z
    ...
    .line 297
    :cond_3
    invoke-virtual {p0, p1, v1, p3}, Lcom/firebase/client/core/SyncTree;->applyTaggedQueryOverwrite(Lcom/firebase/client/core/Path;Lcom/firebase/client/snapshot/Node;Lcom/firebase/client/core/Tag;)Ljava/util/List;
...
.method public calcCompleteEventCache(Lcom/firebase/client/core/Path;Ljava/util/List;)Lcom/firebase/client/snapshot/Node;
    ...
    .line 727
    invoke-virtual {v0, v5}, Lcom/firebase/client/core/Path;->child(Lcom/firebase/client/snapshot/ChildKey;)Lcom/firebase/client/core/Path;
    ...
    invoke-virtual {v4, v5}, Lcom/firebase/client/core/utilities/ImmutableTree;->getChild(Lcom/firebase/client/snapshot/ChildKey;)Lcom/firebase/client/core/utilities/ImmutableTree;

    move-result-object v4

    .line 730
    :goto_1
    invoke-virtual {v4}, Lcom/firebase/client/core/utilities/ImmutableTree;->getValue()Ljava/lang/Object;
    ...
    .line 732
    invoke-virtual {v0, v6}, Lcom/firebase/client/core/SyncPoint;->getCompleteServerCache(Lcom/firebase/client/core/Path;)Lcom/firebase/client/snapshot/Node;
    ...
    invoke-virtual {v1, p1, v0, p2, v2}, Lcom/firebase/client/core/WriteTree;->calcCompleteEventCache(Lcom/firebase/client/core/Path;Lcom/firebase/client/snapshot/Node;Ljava/util/List;Z)Lcom/firebase/client/snapshot/Node;
...
.method public removeAllEventRegistrations(Lcom/firebase/client/core/view/QuerySpec;Lcom/firebase/client/FirebaseError;)Ljava/util/List;
    ...
    .param p1    # Lcom/firebase/client/core/view/QuerySpec;
        ...
        .end annotation
    .end param
    .param p2    # Lcom/firebase/client/FirebaseError;
        .annotation build Lcom/firebase/client/annotations/NotNull;
        .end annotation
    .end param
    .annotation system Ldalvik/annotation/Signature;

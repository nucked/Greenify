...
# direct methods
.method constructor <init>(Lakq;Landroid/content/Context;Ljava/lang/String;)V
    .locals 2
...
.method private a(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    invoke-direct {p0, p1, v2}, Lakr;->b(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)Ljava/util/Set;
...
.method private a(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)Z
    ...
    :goto_1
    :try_start_2
    iget-object v2, p0, Lakr;->a:Lakq;

    const-string v3, "Error querying for table"

    invoke-virtual {v2, v3, p2, v0}, Lakq;->c(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)V
    :try_end_2
...
.method private b(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    invoke-direct {p0, p1, v1}, Lakr;->b(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)Ljava/util/Set;
...
.method public getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-static {v0}, Lakq;->a(Lakq;)Lajr;
    ...
    invoke-virtual {v0, v1}, Lakq;->f(Ljava/lang/String;)V

    iget-object v0, p0, Lakr;->a:Lakq;

    invoke-static {v0}, Lakq;->b(Lakq;)Ljava/lang/String;

    move-result-object v0

    iget-object v1, p0, Lakr;->a:Lakq;

    invoke-virtual {v1}, Lakq;->o()Landroid/content/Context;
    ...
    invoke-static {v1}, Lakq;->a(Lakq;)Lajr;

    move-result-object v1

    invoke-virtual {v1}, Lajr;->b()V
    :try_end_1
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_1 .. :try_end_1} :catch_1
    ...
    invoke-virtual {v1, v2, v0}, Lakq;->e(Ljava/lang/String;Ljava/lang/Object;)V
...
.method public onCreate(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    invoke-static {v0}, Lalo;->a(Ljava/lang/String;)Z
...
.method public onOpen(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    invoke-direct {p0, p1, v0}, Lakr;->a(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)Z

    move-result v0

    if-nez v0, :cond_1

    invoke-static {}, Lakq;->G()Ljava/lang/String;
    ...
    :cond_1
    invoke-direct {p0, p1}, Lakr;->a(Landroid/database/sqlite/SQLiteDatabase;)V

    goto :goto_0

    :cond_2
    invoke-direct {p0, p1}, Lakr;->b(Landroid/database/sqlite/SQLiteDatabase;)V

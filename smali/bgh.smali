...
.method constructor <init>(Lbey;Landroid/content/Context;)V
    .locals 2
    ...
    invoke-direct {p0, p1, p2, v0, v1}, Lbgh;-><init>(Lbey;Landroid/content/Context;Ljava/lang/String;I)V

    return-void
.end method

.method constructor <init>(Lbey;Landroid/content/Context;Ljava/lang/String;I)V
    .locals 3
    ...
    iput-object v0, p0, Lbgh;->e:Landroid/content/Context;

    iput-object p3, p0, Lbgh;->f:Ljava/lang/String;

    iput-object p1, p0, Lbgh;->d:Lbey;

    invoke-static {}, Lazp;->c()Lazo;

    move-result-object v0

    iput-object v0, p0, Lbgh;->h:Lazo;

    new-instance v0, Lbgj;

    iget-object v1, p0, Lbgh;->e:Landroid/content/Context;

    iget-object v2, p0, Lbgh;->f:Ljava/lang/String;

    invoke-direct {v0, p0, v1, v2}, Lbgj;-><init>(Lbgh;Landroid/content/Context;Ljava/lang/String;)V

    iput-object v0, p0, Lbgh;->b:Lbgj;
    ...
    invoke-direct {v2, p0}, Lbgi;-><init>(Lbgh;)V

    invoke-direct {v0, v1, v2}, Lbib;-><init>(Landroid/content/Context;Lbid;)V

    iput-object v0, p0, Lbgh;->c:Lbee;

    const-wide/16 v0, 0x0

    iput-wide v0, p0, Lbgh;->g:J
...
.method private a(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    ...
    :try_start_0
    iget-object v0, p0, Lbgh;->b:Lbgj;

    invoke-virtual {v0}, Lbgj;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    :try_end_0
    ...
    invoke-static {p1}, Lbfo;->b(Ljava/lang/String;)V
...
.method static synthetic a(Lbgh;)Lazo;
    .locals 1

    iget-object v0, p0, Lbgh;->h:Lazo;
...
.method private a(J)V
    ...
    invoke-virtual {p0, v0}, Lbgh;->a([Ljava/lang/String;)V
...
.method private a(JJ)V
    ...
    invoke-direct {p0, v0}, Lbgh;->a(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-direct {p0, p1, p2}, Lbgh;->a(J)V

    goto :goto_0
.end method

.method static synthetic a(Lbgh;J)V
    .locals 1
...
.method static synthetic a(Lbgh;JJ)V
    .locals 1

    invoke-direct {p0, p1, p2, p3, p4}, Lbgh;->a(JJ)V

    return-void
.end method

.method static synthetic b(Lbgh;)Ljava/lang/String;
    .locals 1

    iget-object v0, p0, Lbgh;->f:Ljava/lang/String;
...
.method private b(JLjava/lang/String;)V
    ...
    iget-object v0, p0, Lbgh;->d:Lbey;

    const/4 v1, 0x0

    invoke-interface {v0, v1}, Lbey;->a(Z)V
    :try_end_0
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method static synthetic c(Lbgh;)Landroid/content/Context;
    .locals 1

    iget-object v0, p0, Lbgh;->e:Landroid/content/Context;
...
.method private f()V
    ...
    invoke-virtual {p0, v0}, Lbgh;->a(I)Ljava/util/List;
...
.method public a()V
    ...
    iget-object v0, p0, Lbgh;->c:Lbee;

    invoke-interface {v0}, Lbee;->a()Z
    ...
    invoke-virtual {p0, v0}, Lbgh;->b(I)Ljava/util/List;
    ...
    :cond_2
    iget-object v1, p0, Lbgh;->c:Lbee;

    invoke-interface {v1, v0}, Lbee;->a(Ljava/util/List;)V

    invoke-virtual {p0}, Lbgh;->d()I
...
.method public a(JLjava/lang/String;)V
    ...
    invoke-direct {p0}, Lbgh;->f()V

    invoke-direct {p0, p1, p2, p3}, Lbgh;->b(JLjava/lang/String;)V
...
.method a([Ljava/lang/String;)V
    ...
    invoke-direct {p0, v2}, Lbgh;->a(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    ...
    :goto_1
    invoke-interface {v2, v0}, Lbey;->a(Z)V
    :try_end_0
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method b()I
    ...
    iget-object v2, p0, Lbgh;->h:Lazo;

    invoke-interface {v2}, Lazo;->a()J

    move-result-wide v2

    iget-wide v4, p0, Lbgh;->g:J
    ...
    iget-object v3, p0, Lbgh;->h:Lazo;

    invoke-interface {v3}, Lazo;->a()J
    ...
    :goto_1
    invoke-interface {v3, v0}, Lbey;->a(Z)V
...
.method public b(I)Ljava/util/List;
    ...
    invoke-direct {v0, v2}, Lbgh;->a(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-direct/range {v3 .. v9}, Lbes;-><init>(JJJ)V
    ...
    invoke-virtual {v2, v5}, Lbes;->a(Ljava/lang/String;)V
    ...
    invoke-virtual {v2}, Lbes;->c()Ljava/lang/String;

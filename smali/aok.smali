...
.method public constructor <init>(Landroid/app/Activity;Ljava/util/List;Ljava/util/Map;)V
    ...
    :cond_1
    invoke-direct {p0, v0, p1, v1}, Laok;->a(Laow;Landroid/app/Activity;Ljava/util/List;)Layl;
...
.method private a(Laow;Landroid/app/Activity;Ljava/util/List;)Layl;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0, p1}, Laow;->equals(Ljava/lang/Object;)Z
    ...
    invoke-direct {v0, p2, p3}, Layo;-><init>(Landroid/app/Activity;Ljava/util/List;)V
...
# virtual methods
.method public a(Laow;)Layl;
    .locals 1

    invoke-static {p1}, Lave;->a(Ljava/lang/Object;)Ljava/lang/Object;

    iget-object v0, p0, Laok;->a:Ljava/util/Map;
